#ifndef MOLDORIANLINEWRAPPER_H
#define MOLDORIANLINEWRAPPER_H
...
class MoldorianLineWrapper : public BlackT::TLineWrapper {
public:
  typedef std::map<int, int> CharSizeTable;

  MoldorianLineWrapper(BlackT::TStream& src__,
